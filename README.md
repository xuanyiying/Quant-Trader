...
`quant-trader` is the core infrastructure of the Quant Trader system, designed for **high concurrency, low latency, and high availability**. It integrates multi-exchange data ingestion, streaming K-line aggregation, asynchronous batch persistence, and real-time market data push.
